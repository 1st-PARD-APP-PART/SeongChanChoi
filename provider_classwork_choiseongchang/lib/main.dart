...
import 'package:provider_classwork_choiseongchang/bucket_service.dart';

void main() {
  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider<BucketService>(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  // 추가하기 버튼 클릭시
                  String job = textController.text; // 텍스트 입력창의 값 가져오기
                  if (job.isEmpty) {
                    setState(() {
                      error = "할 일을 입력해 주세요.";
                    });
